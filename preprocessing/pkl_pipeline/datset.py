...
SQL_USERNAME = 'funcom_pre'
SQL_PASSWORD = 'funcom_pre'
...
def main():
    ...
    reswordsfd = open('res_list.txt', 'r')
    global reswords
    reswords = set()
    for l in reswordsfd:
        l = l.rstrip()
    ...
    datsfile = 'datasets/funcom_filtered_reduced/codes.pkl'
    ...
    for line in open(comfile):
        ...
        tmp = tmp.split()
        if len(tmp) > 100:
            continue #TODO: append those to invalid IDS later
