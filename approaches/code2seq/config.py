class Config:
    ...
    def get_default_config(args):
        ...
        config.PATIENCE = 10
        config.BATCH_SIZE = 256 #i chnaged that from 512
        ...
        config.EMBEDDINGS_SIZE = 128 * 4 #128 * 2 #128
        config.RNN_SIZE = 128 * 4 #128 * 2  # Two LSTMs to embed paths, each of size 128
        ...
        config.EMBEDDINGS_DROPOUT_KEEP_PROB = 0.3 #0.75
        config.RNN_DROPOUT_KEEP_PROB = 0.75 #0.5
        config.BIRNN = True
